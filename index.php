...
<body class="kd-new-website">
	...
	<section class="kd-presentation">
		<div class="kd-influence">
			...
			<p>Boostez votre visibilité et engagez votre cible tout en touchant une nouvelle audience.</p>
	...
	<section class="kd-perso">
		...
		<div class="kd-right-prez">
			...
			<p>Les défis de marques sont aujourd'hui de créer de l'intérêt et de l'engagement auprès de leurs cibles</p>
			<p class="m-b-40">Krowdis répond à ces problématiques en proposant à votre cible de re-créer et partager vos contenus. Cela vous permet par ailleurs de toucher une nouvelle cible</p>
	...
	<section class="kd-using">
		...
		<p class="kd-prez-footer2">c'est pourquoi tout contenu est modéré avant publication</p>
	</section>
	<section class="kd-mission">
		<h2>Nos missions</h2>
		<div>
			<article class="i-b">
				<div>
					<img src="assets/img/lunettes.png" class="kd-mission-logo">
					<div class="i-b kd-miss-desc">
						<h3>Plus de vidibilité</h3>
						<p>La possibilité de voir des amis, voisins ou collègue sur du contenu boost l'intérêt de votre cible</p>
					</div>
				</div>
				<div>
					<img src="assets/img/barres.png" class="kd-mission-logo">
					<div class="i-b kd-miss-desc">
						<h3>Hausse de l'engagement</h3>
						<p>La personnifacation du contenu entraine de forte de fortes interactions sur les réseaux sociaux.</p>
					</div>
				</div>
				<div>
					<img src="assets/img/homme.png" class="kd-mission-logo">
					<div class="i-b kd-miss-desc">
						<h3>Nouvelle cible touchée</h3>
						<p>En partageant vos contenu, l'user devient ambassadeur de la marque en la diffusant dans sa communauté.</p>
					</div>
				</div>
			</article>
			<article class="i-b kd-mission-center">
				<img src="assets/img/personnages.png" class="kd-img-center">
			</article>
			<article class="i-b">
				<div>
					<img src="assets/img/diamant.png" class="kd-mission-logo">
					<div class="i-b kd-miss-desc">
						<h3>Authenticité</h3>
						<p>Ce n'est pas la marque qui diffuse du contenu, mais un ami en qui l'utilisateur a confiance</p>
					</div>
				</div>
				<div>
					<img src="assets/img/horloge.png" class="kd-mission-logo">
					<div class="i-b kd-miss-desc">
						<h3>Sessions plus longues</h3>
						<p>Grâce à notre gamification, l'utilisateur interagit avec votre marque pendant des laps de temps élevés</p>
					</div>
				</div>
				<div>
					<img src="assets/img/ampoule.png" class="kd-mission-logo">
					<div class="i-b kd-miss-desc">
						<h3>Forte mémorisation</h3>
						<p>La personnification du contenu génère un fort taux de mémorisation par rapport au contenu classique.</p>
					</div>
				</div>
			</article>
		</div>
